...
set_carrier_init_language ()
{
    case $boot_carrier in
        ...
        ;;
        altmx|amxar|amxcl|amxco|amxla|amxmx|amxpe|amxpr|attmx|avaco|entcl|iusmx|niicl|niimx|niipe|opencl|openla|openmx|openpe|perar|retar|retcl|retla|retla1st|retmx|retpe|tefar|tefcl|tefco|tefla|tefmx|tefpe|tefunl|tigca|tigca1st|tigco|womcl|openpub )
